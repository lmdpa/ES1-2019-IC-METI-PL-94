	...
	private void initialize() {
		...
		criar_regra.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println( "SE ( " + metrica1 + " " + comparador1 +" " + " " + v1 + " " + operador + " " + metrica2 + " " + comparador2 + " " +  v2 + " ) Ent�o is_long_method = " + ex);
				}		
					...
					System.out.println( "SE ( " + metrica1 + " " + comparador1 +" " + " " + v1 + " " + operador + " " + metrica2 + " " + comparador2 + " " +  v2 + " ) Ent�o is_feature_envy = " + ex);
